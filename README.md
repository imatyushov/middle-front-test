**Технологии: React, TypeScript, Redux(state manager), AntDesign**

**Реализована авторизация по моковым данным; валидация формы с логином**

**Логика добавления событий на соотве**

**Для работы с календарем используется библиотека Moment**

**Отдельные редюсеры по работе с авторизацией и событиями в календаре**
